...
var resultUl = document.querySelector('.results');
function getCountry(_x) {
  return _getCountry.apply(this, arguments);
}
function _getCountry() {
  _getCountry = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(search) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("https://restcountries.com/v3.1/name/".concat(search));
        case 3:
        ...
        case 12:
          ...
          resultUl.innerHTML = "\n            ".concat(data.map(function (country) {
            return "<li>".concat(country.name.common, "</li>");
          }).join(''), "\n            ");
          box.innerHTML = '';
          return _context.abrupt("return");
        case 18:
          ...
          (0, _core.error)({
            title: 'Error',
            text: "Too many matches(exactly ".concat(data.length, "), do more precise search")
          });
          return _context.abrupt("return");
        case 24:
          _context.next = 29;
...
function renderCountries(countries) {
  var html = countries.map(function (country) {
    return "\n            <h2>".concat(country.name.common, "</h2>\n            <ul class=\"sides-list\">\n                <li class=\"info\">\n                    <p>Capital: ").concat(country.capital, "</p>\n                    <p>Population: ").concat(country.population, "</p>\n                    <p>Languages:</p>\n                    <ul>\n                        ").concat(Object.values(country.languages).map(function (language) {
      return "<li>".concat(language, "</li>");
    }).join(''), "\n                    </ul>\n                </li>\n                <li class=\"flag\">\n                    <img src=\"").concat(country.flags.png, "\">\n                </li>\n            </ul>\n        ");
  });
  box.innerHTML = html;
}
searchInput.addEventListener('input', (0, _debounce.default)(function () {
